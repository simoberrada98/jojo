...
// Helper types for product with computed fields
...
// Display product type for frontend components
...
// Transform Supabase Product to DisplayProduct for components
export function transformToDisplayProduct(dbProduct: Product, rating = 4.5, reviewCount = 0): DisplayProduct {
  return {
    id: dbProduct.id,
    name: dbProduct.name,
