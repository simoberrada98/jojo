...
import { DEFAULT_CURRENCY, type Currency, CONVERSION_RATES as FALLBACK_RATES } from "@/lib/config/currency.config";
...
export function CurrencyProvider({ children }: { children: ReactNode }) {
  ...
  const [conversionRates, setConversionRates] = useState<Record<Currency, number>>(FALLBACK_RATES);
  ...
  return (
    <CurrencyContext.Provider
      value={{ currency, setCurrency, convertPrice, formatPrice, conversionRates }}
    >
      {children}
    </CurrencyContext.Provider>
  );
