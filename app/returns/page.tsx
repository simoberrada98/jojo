      ...
      <div className="space-y-6">
        <Card>
          ...
          <CardContent className="prose prose-sm max-w-none dark:prose-invert">
            <p>
              We offer a <strong>14-day return window</strong> from the date of delivery for most products. Mining hardware must be returned in original, unopened condition to be eligible for a full refund.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="prose prose-sm max-w-none dark:prose-invert">
            ...
            <div className="bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mt-4 flex gap-3">
              <AlertCircle className="h-5 w-5 text-amber-600 flex-shrink-0 mt-0.5" />
              <p className="text-sm m-0">
                <strong>Important:</strong> Returns without an RMA number will be refused. Please do not ship items back without authorization.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="prose prose-sm max-w-none dark:prose-invert">
            ...
            <p className="mt-4 font-semibold">
              Report damage within 48 hours of delivery for fastest resolution.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="prose prose-sm max-w-none dark:prose-invert">
            <p>
              We do not offer direct exchanges. If you need a different item, please return the original for a refund and place a new order.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="prose prose-sm max-w-none dark:prose-invert">
            <p>
              Most mining hardware comes with manufacturer warranty. For warranty claims:
            </p>
            <ul>
            ...
            <p className="mt-4">
              We can assist in facilitating warranty claims if needed. Contact our support team for assistance.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="prose prose-sm max-w-none dark:prose-invert">
            <p>
              International customers are responsible for return shipping costs and any customs fees. We recommend using a trackable shipping method with insurance.
            </p>
          </CardContent>
        </Card>
