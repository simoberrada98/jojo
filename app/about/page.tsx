      ...
      <div className="mx-auto px-4 py-12 container">
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <P className="m-0 text-muted-foreground text-lg">
                At Jhuangnyc, we're dedicated to making cryptocurrency mining
                accessible to everyone. We provide high-quality ASIC miners from
                leading manufacturers, backed by exceptional customer service
                and competitive pricing. Our goal is to empower miners of all
                sizes to participate in blockchain networks and contribute to
          ...
          <Card>
            ...
            <CardContent className="dark:prose-invert max-w-none prose prose-sm">
              ...
              <p>
                ...
                in the cryptocurrency mining community. We've helped thousands
                of miners—from hobbyists setting up their first rig to
          ...
          <Card>
            ...
            <CardContent className="dark:prose-invert max-w-none prose prose-sm">
              <p>
                ...
                engineering, and customer service. We're passionate miners
        ...
        <div className="mx-auto mb-16 max-w-4xl">
          <Card>
            ...
            <CardContent className="dark:prose-invert max-w-none prose prose-sm">
              <p>
                Jhuangnyc is more than just a store—we're a community of miners
                supporting each other's success. Stay connected with us:
              </p>
              <ul>
                <li>
