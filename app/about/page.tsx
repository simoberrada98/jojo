      ...
      <div className='mx-auto px-4 py-12 container'>
          ...
          <Card>
            <CardContent className='pt-6'>
              ...
              <P className='m-0 text-muted-foreground text-lg'>
                At Jhuangnyc, we&rsquo;re dedicated to making cryptocurrency mining
          ...
          <Card>
            ...
            <CardContent className='dark:prose-invert max-w-none prose prose-sm'>
              ...
              <p>
                ...
                in the cryptocurrency mining community. We&rsquo;ve helped thousands
        ...
        <div className='mx-auto mb-16 max-w-4xl'>
          <Card>
            ...
            <CardContent className='dark:prose-invert max-w-none prose prose-sm'>
              <p>
                Jhuangnyc is more than just a store—we&rsquo;re a community of miners
                supporting each other&rsquo;s success. Stay connected with us:
              </p>
              <ul>
                <li>
